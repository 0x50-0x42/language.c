...
void Qsort(int maxfields, int field, char* (*lines)[maxfields], int left, int right, int (*comp)(void*, void*)) {
	...
	Qsort(maxfields, field, lines, left, swappedIdx - 2, comp);
	Qsort(maxfields, field, lines, swappedIdx, right, comp);
}
